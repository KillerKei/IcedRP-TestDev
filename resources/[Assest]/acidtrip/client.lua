...
RegisterNetEvent('doAcid')
AddEventHandler('doAcid', function()
  RequestAnimDict('mp_suicide')
	while not HasAnimDictLoaded('mp_suicide') do
		Citizen.Wait(10)
	end
  TaskPlayAnim(PlayerPedId(), "mp_suicide", "pill", 2.0, 3.0, -1, 49, 1, 0, 0, 0)
  exports["irp-taskbar"]:taskBar(3000, "Taking Acid")
