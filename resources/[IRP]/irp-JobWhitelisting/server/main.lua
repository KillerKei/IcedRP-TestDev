...
irpCore.RegisterServerCallback('irp-joblisting:getJobsList', function(source, cb)
...
RegisterServerEvent('irp-joblisting:setJob')
AddEventHandler('irp-joblisting:setJob', function(job)
	local _source = source
	local xPlayer = irpCore.GetPlayerFromId(_source)
