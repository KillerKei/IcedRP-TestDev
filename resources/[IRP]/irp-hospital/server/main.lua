...
AddEventHandler('irp-hospital:server:EnteredBed', function()
    ...
    TriggerClientEvent('chat:addMessage', source, {template = '<div class="chat-message phonem"><b> {0}:</b> {1}</div>', args = {"Service", 'It was a success, you have been billed for your injuries in the amount of $' .. totalBill ..'.'} })
