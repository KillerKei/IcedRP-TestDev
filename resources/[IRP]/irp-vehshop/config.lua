...
Config.MinDownpayment 			= 30		-- set minimum allowed downpayment that car seller can go down to in %
Config.MaxDownpayment 			= 75		-- set maximum allowed downpayment that car seller can go down to in %
