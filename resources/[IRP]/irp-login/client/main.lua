...
-- 				DrawText3Ds(logoutspot.x,logoutspot.y,logoutspot.z + 0.10, "[~g~/logout~s~] - Swap Characters")
-- 			end
-- 		end
-- 	end
-- end)
...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
	...
	if isnew then
		...
		TriggerServerEvent("grp-clothing:get_character_current")
		TriggerServerEvent("grp-clothing:get_character_face")
		TriggerServerEvent("grp-clothing:retrieve_tats")
		TriggerScreenblurFadeOut(0)
	end
end)
