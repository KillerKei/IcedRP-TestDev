...
else if(secondInventory == "181")
{
    var targetinvname = targetName;
    var shopArray = Bahamas();
    var shopAmount = 18;
    emitNet("inventory-open-target", src, [invArray,arrayCount,playerinvname,shopArray,shopAmount,targetinvname,500,false]);
}    
...
function Bahamas() {
    var shopItems = [
        { item_id: "vodka", id: 0, name: "Shop", information: "{}", slot: 1, amount: 50 },
        { item_id: "whiskey", id: 0, name: "Shop", information: "{}", slot: 2, amount: 50 },
        { item_id: "champagne", id: 0, name: "Shop", information: "{}", slot: 3, amount: 50 },
        { item_id: "rum", id: 0, name: "Shop", information: "{}", slot: 4, amount: 50 },
        { item_id: "redwine", id: 0, name: "Shop", information: "{}", slot: 5, amount: 1 },
        { item_id: "armor", id: 0, name: "Shop", information: "{}", slot: 6, amount: 10 },
        { item_id: "joint", id: 0, name: "Shop", information: "{}", slot: 7, amount: 2 },
        { item_id: "bfsandwich", id: 0, name: "Shop", information: "{}", slot: 8, amount: 1 },
        { item_id: "coffee", id: 0, name: "Shop", information: "{}", slot: 9, amount: 1 },
        { item_id: "cola", id: 0, name: "Shop", information: "{}", slot: 10, amount: 1 },
        { item_id: "burrito", id: 0, name: "Shop", information: "{}", slot: 11, amount: 1 },
        { item_id: "eggsbacon", id: 0, name: "Shop", information: "{}", slot: 12, amount: 1 },
        { item_id: "donut", id: 0, name: "Shop", information: "{}", slot: 13, amount: 1 },
        { item_id: "foodingredient", id: 0, name: "Shop", information: "{}", slot: 14, amount: 1 },
        { item_id: "bleederburger", id: 0, name: "Shop", information: "{}", slot: 15, amount: 10 },
        { item_id: "water", id: 0, name: "Shop", information: "{}", slot: 16, amount: 1 },
        { item_id: "hotdog", id: 0, name: "Shop", information: "{}", slot: 17, amount: 1 },
        { item_id: "hamburger", id: 0, name: "Shop", information: "{}", slot: 18, amount: 10 },
        { item_id: "mshake", id: 0, name: "Shop", information: "{}", slot: 19, amount: 1 },
    ];
    return JSON.stringify(shopItems);
}
