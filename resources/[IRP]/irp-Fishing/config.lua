Config = {}
	...
	---------------------------------------------------------------
	--Time in miliseconds
	Config.FishTime = {a = 10000, b = 30000}
	...
	Config.FishPrice = {a = 20, b = 40} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 50, b = 100} --Will get dirty money
	Config.SharkPrice = {a = 250, b = 500} --Will get dirty money

	--------------------------------------------------------
	--=====Locations where players can sell stuff========--
	--------------------------------------------------------

	Config.SellFish = {x = -1039.25, y = -1396.45, z = 5.55} --Place where players can sell their fish
	Config.SellTurtle = {x = 3804.0, y = 4443.3, z = 3.2} --Place where players can sell their turtles 
	Config.SellShark = {x = 2517.6 , y = 4218.0, z = 39.0} --Place where players can sell their sharks
