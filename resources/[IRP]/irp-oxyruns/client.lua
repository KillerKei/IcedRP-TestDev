...
local OxyDropOffs = {
	[1] =  { ['x'] = -100.6333,['y'] = 6376.611,['z'] = 31.47791,['h'] = 224.656, ['info'] = ' 1' },
	[2] =  { ['x'] = -284.5195,['y'] = 6172.232,['z'] = 31.49936,['h'] = 315.786, ['info'] = ' 2' },
	[3] =  { ['x'] = -670.4279,['y'] = 5828.85,['z'] = 17.33132,['h'] = 236.017, ['info'] = ' 3' },
	[4] =  { ['x'] = -100.6709,['y'] = 6107.404,['z'] = 31.462,['h'] = 239.252, ['info'] = ' 4' },
	[5] =  { ['x'] = -251.5338,['y'] = 6101.654,['z'] = 31.37912,['h'] = 43.033, ['info'] = ' 5' },
	[6] =  { ['x'] = -1058.924,['y'] = 4915.319,['z'] = 211.8189,['h'] = 192.1301, ['info'] = ' 6' },
	[7] =  { ['x'] = 1510.541,['y'] = 6326.064,['z'] = 24.60713,['h'] = 57.402, ['info'] = ' 7' },
	[8] =  { ['x'] = 1469.687,['y'] = 6549.742,['z'] = 14.90413,['h'] = 352.369, ['info'] = ' 8' },
	[9] =  { ['x'] = -754.049,['y'] = 5595.047,['z'] = 41.66505,['h'] = 84.934, ['info'] = ' 9' },
	[10] =  { ['x'] = -581.7,['y'] = 5356.68,['z'] = 70.25223,['h'] = 251.040, ['info'] = ' 10' },
}
...
local pillStore =  { ['x'] = -288.3805,['y'] = 6299.166,['z'] = 31.49224,['h'] = 228.204, ['info'] = ' oxy bruv' }

local pillWorker = { ['x'] = -288.3805,['y'] = 6299.166,['z'] = 31.49224,['h'] = 228.204, ['info'] = ' lol' }
...
local carspawns = {
	[1] =  { ['x'] = -287.5125,['y'] = 6304.255,['z'] = 31.49225,['h'] = 47.7504, ['info'] = ' car 8' },
	[2] =  { ['x'] = -287.5125,['y'] = 6304.255,['z'] = 31.49225,['h'] = 47.7504, ['info'] = ' car 1' },
	[3] =  { ['x'] = -287.5125,['y'] = 6304.255,['z'] = 31.49225,['h'] = 47.7504, ['info'] = ' car 2' },
	[4] =  { ['x'] = -287.5125,['y'] = 6304.255,['z'] = 31.49225,['h'] = 47.7504, ['info'] = ' car 3' },
	[5] =  { ['x'] = -287.5125,['y'] = 6304.255,['z'] = 31.49225,['h'] = 47.7504, ['info'] = ' car 4' },
	[6] =  { ['x'] = -287.5125,['y'] = 6304.255,['z'] = 31.49225,['h'] = 47.7504, ['info'] = ' car 5' },
	[7] =  { ['x'] = -287.5125,['y'] = 6304.255,['z'] = 31.49225,['h'] = 47.7504, ['info'] = ' car 6' },
	[8] =  { ['x'] = -287.5125,['y'] = 6304.255,['z'] = 31.49225,['h'] = 47.7504, ['info'] = ' car 7' },
}
				...
				if dstcheck < 5.0 then
				    ...
				    if IsControlJustReleased(0,38) then
						...
						if night then
					    	...
					    	TriggerServerEvent("drugdelivery:server",12)
					    	Citizen.Wait(1500)
					    end
...
function DoDropOff(requestMoney)
	...
	if DoesEntityExist(deliveryPed) and not IsEntityDead(deliveryPed) then
		...
		if HasStolenGoods() then
			...
			if math.random(10) == 1 then
				TriggerServerEvent( "player:receiveItem", "gruppe6", 1 )
				--TriggerServerEvent( "player:receiveItem", "lockpick", math.random(4) )
			end
			...
			if OxyRun then
		        ...
		        if exports["irp-inventory"]:hasEnoughOfItem("rollcash",10,false) then     
		        ...
		        elseif exports["irp-inventory"]:hasEnoughOfItem("markedbills",1,false) then     
				...
				if math.random(100) > 45 then
					TriggerServerEvent( "player:receiveItem", "vicodin", math.random(5) )
				end
			else
	...
	if success then
		...
		TriggerEvent("client:newStress",true)
