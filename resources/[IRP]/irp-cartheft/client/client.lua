...
-- RegisterNetEvent('irp-cartheft:moneycheck')
-- AddEventHandler('irp-cartheft:moneycheck', function(price, _source)
--     if price == true then 
--         -- TriggerEvent('DoLongHudText', 'You need $2,000 to start this mission', 2)
--         print('hikids')
--     else
--         print('breasty')
--     end
