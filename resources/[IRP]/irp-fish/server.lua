...
local _source = source
    ...
    if roll == 1 then
        TriggerClientEvent('player:receiveItem', _source, "fish", math.random(1,3))
    end
    if roll == 2 then
        TriggerClientEvent('player:receiveItem', _source, 'plastic', math.random(1,3))
    end
    if roll == 3 then
        TriggerClientEvent('player:receiveItem', _source, 'aluminium', math.random(1,5))
    end
    if roll == 4 then
        TriggerClientEvent('player:receiveItem', _source, '1gcocaine', math.random(1,2))
    end
    if roll == 5 then
        TriggerClientEvent('player:receiveItem', _source, "fish", math.random(1,3))
    end
