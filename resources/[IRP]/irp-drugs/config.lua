...
-- Job Settings:
Config.CooldownTime = 90					-- Set cooldown time for doing drug jobs in minutes
Config.HackerDevice = "unknown"				-- Name in database for hacker device
...
-- List of Drugs:
Config.ListOfDrugs = {
	{ drug = 'coke', label = 'Coke', Enabled = true, BuyPrice = 1500, MinReward = 1, MaxReward = 3 },
	{ drug = 'meth', label = 'Meth', Enabled = true, BuyPrice = 1500, MinReward = 1, MaxReward = 3 },
	--{ drug = 'weed', label = 'Weed', Enabled = true, BuyPrice = 100, MinReward = 1, MaxReward = 3 },
}
...
Config.DrugSaleCooldown = 25					-- Cooldown between each selling in seconds.
Config.SellDrugsBarText = "Selling Drugs"		-- Progress Bar Text for selling drugs
Config.SellDrugsTime = 10						-- time taken to negotiate with NPC in seconds
...
Config.DrugConversion = {
	{ 
		...
		ProgressBarText			= "Coke Brick -> Cocaine 10g",	-- progress bar text
	...
	{ 
		...
		HighQualityScale		= true,							-- enable/disable scale feature for the drugType
		hqscale					= "hqscale",					-- item name in database for hiqh quality scale item
		ProgressBarText			= "Coke 10g -> Crack 1g",		-- progress bar text
		ConversionTime			= 5000,							-- set conversion time in MS.
	},
	{ 
